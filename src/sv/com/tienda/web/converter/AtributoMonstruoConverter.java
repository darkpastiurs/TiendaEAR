...
@FacesConverter(value = "AtributoMonstruoConverter", forClass = AtributoMonstruo.class)
public class AtributoMonstruoConverter implements Converter {
    @Override
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String s) {
        try {
            return ConverterUtils.getAsObject(AtributoMonstruo.class, s);
